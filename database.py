...
class DraftLines(db.Model):
    ...
    draft_id = db.Column(db.Integer, db.ForeignKey(
        "drafts.draft_id"),  nullable=False)
    line_num = db.Column(db.String, nullable=False)
    line_text = db.Column(db.String, nullable=False)
...
class Poems(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey("users.id"), nullable=False)
    poem_count = db.Column(db.Integer, db.ForeignKey(
        "users.poem_count"), nullable=False)
    rhyme_scheme = db.Column(db.String(50), nullable=False)
    rhymes = db.Column(db.String(), nullable=False)
    title = db.Column(db.Integer)
    line_break = db.Column(db.Integer)
...
class PoemLines(db.Model):
    ...
    poem_id = db.Column(db.Integer, db.ForeignKey(
        "poems.poem_id"),  nullable=False)
    line_num = db.Column(db.String, nullable=False)
    line_text = db.Column(db.String, nullable=False)
