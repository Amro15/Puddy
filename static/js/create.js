...
let RHYME_DESCRIPTION = {
    ...
    "Blank Verse": "<h3>Blank Verse</h3><br><u>Description:</u> Blank Verse describes a poem that follows no specific rhyme scheme but does follow a meter (usually in iambic pentameter).<br><br>This scheme contains <b>edit mode</b> which allows you to edit your poem on the fly, add or remove lines, change rhymes, and more. It is the most versatile tool we have to offer try it out!<br><u>Example:</u> William Shakespear, To be or not to be.<br><br>To be, or not to be, that is the question:<br>Whether 'tis nobler in the mind to suffer<br>The slings and arrows of outrageous fortune,<br><br>Or to take arms against a sea of troubles<br>And by opposing end them. To die—to sleep,<br>No more; and by a sleep to say we end<br>The heart-ache and the thousand natural shocks<br>That flesh is heir to: 'tis a consummation<br>Devoutly to be wish'd. To die, to sleep;<br>To sleep, perchance to dream—ay, there's the rub<br>For in that sleep of death what dreams may come,<br>When we have shuffled off this mortal coil,<br>Must give us pause—there's the respect<br>That makes calamity of so long life…:",
    "Free Verse": "<h3>Free Verse</h3><br><u>Description:</u> Free Verse describes a poem that follows no specific rhyme scheme or rythm.<br><br>This scheme contains <b>edit mode</b> which allows you to edit your poem on the fly, add or remove lines, change rhymes, and more. It is the most versatile tool we have to offer try it out!<br><u>Example:</u> Walt Whitman, When I Heard the Learn'd Astronomer.<br><br>When I heard the lear'd astronomer,<br>When the proofs, the figures, were ranged in columns before me,<br>When I was shown the charts and diagrams, to add, divide, and measure them,<br><br>When I sitting heard the astronomer where he lectured with much applause in the lecture-room,<br>How soon unaccountable I became tired and sick,<br>Till rising and gliding out I wander'd off by myself,<br>In the mystical moist night-air, and from time to time,<br>Look'd up in perfect silence at the stars.",
    "Custom": "<h3>Custom</h3><br><u>Description:</u> Feeling adventurous? Create your own rhyme scheme!<br><br>Type <b>- (dash symbol)</b> while specifying your <b>rhymes</b> if you wish to have a line that will not be checked for rhymes when using the rhyme check feature<br><br>This scheme contains <b>edit mode</b> which allows you to edit your poem on the fly, add or remove lines, change rhymes, and more. It is the most versatile tool we have to offer try it out!",
    ...
    "Haiku": "<h3>Haiku</h3><br><p><u>Description: </u>Haiku describes a japanese poem of 3 lines and (5/7/5) 17 syllables total usually talking about nature.<br>The check syllables feature has been modified to display when all lines have the right amount of syllables total<br><br><u>Example: </u> Matsuo Bashō, The Old Pond<br>An old silent pond<br>A frog jumps into the pond—<br>Splash! Silence again.</p><br>(rhyme and meter features are disabled when in this mode)"
};
RHYME_DESCRIPTION = Object.freeze(RHYME_DESCRIPTION);

const SPECIAL_RHYME_SCHEME = []

const FIXED_RHYME_SCHEMES = ["Limerick", "Shakespearean Sonnet", "Haiku", "Free Verse", "Blank Verse", "Custom", "Terza Rima", "Vilanelle"]
const CUSTOM_BR = ["Monorhyme", "Free Verse", "Blank Verse", "Custom"]
...
rhyme_scheme.addEventListener("change", (event) => {
    ...
    if ((event.target.value === "Free Verse" || event.target.value == "Blank Verse")) {
...
random_pick_btn.addEventListener("click", () => {
    let random_rhymes_arr = [];
    for (let i = 0; i < rhyme_scheme.length; i++) {
        if (rhyme_scheme.options[i].getAttribute("disabled") === null) {
            random_rhymes_arr.push(rhyme_scheme.options[i].value);
        }
    }
    random_val = random_rhymes_arr[Math.floor(Math.random() * random_rhymes_arr.length)];
    rhyme_scheme.value = random_val;
